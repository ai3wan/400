...
(2, 'ООО «Компания 2»', 'Разработчик'),
(3, 'ООО «Компания 3»', 'Разработчик'),
(4, 'ООО «Компания 4»', 'Разработчик'),
(5, 'ООО «Компания 5»', 'Разработчик'),
(6, 'ООО «Компания 6»', 'Разработчик'),
(8, 'ООО «Компания 8»', 'Поставщик'),
(9, 'ООО «Компания 9»', 'Поставщик'),
(12, 'ООО «Компания 12»', 'Разработчик'),
(13, 'ООО «Компания 13»', 'Поставщик'),
(14, 'ООО «Компания 14»', 'Поставщик');
...
(1, 'Финансовый', 'Превышение бюджета', 0.5, 'Высокое', 'Открыт'),
(1, 'Поставки', 'Задержка поставки', 0.4, 'Среднее', 'Открыт'),
(2, 'Технический', 'Проблемы совместимости', 0.6, 'Высокое', 'В работе'),
(3, 'Сроки', 'Нехватка ресурсов', 0.35, 'Среднее', 'Открыт'),
(4, 'Финансовый', 'Рост цен на материалы', 0.45, 'Среднее', 'Открыт'),
(5, 'Поставки', 'Проблемы с логистикой', 0.7, 'Критическое', 'Открыт'),
(8, 'Технический', 'Ошибка в расчетах', 0.3, 'Низкое', 'Закрыт'),
(10, 'Финансовый', 'Недофинансирование', 0.55, 'Высокое', 'Открыт'),
(11, 'Юридический', 'Проблемы с сертификацией', 0.4, 'Среднее', 'В работе'),
(13, 'Поставки', 'Задержка комплектующих', 0.5, 'Высокое', 'Открыт'),
(22, 'Технический', 'Необходимость доработки', 0.6, 'Высокое', 'Открыт'),
(25, 'Сроки', 'Срыв сроков', 0.8, 'Критическое', 'Открыт'),
(26, 'Финансовый', 'Нехватка бюджета', 0.35, 'Среднее', 'Открыт');
